@{
    ...
    FunctionsToExport = @('Sync-WUPMRepository', 'Install-WUPMPackage', 'Uninstall-WUPMPackage', 'Get-WUPMInstalled', 'Invoke-WUPMWindowsUpdate', 'Invoke-WUPMRollback', 'Get-WUPMAudit')
    CmdletsToExport = @()
    VariablesToExport = @()
    AliasesToExport = @()
}
